...
@section('account-content')
    ...
    <div class="text-right mb-3">
        {!! Form::open(['action' => '/notifications/clear']) !!}
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item">
                    <span class="float-right h5 mb-2">
                        {!! Form::open(['action' => '/notifications/clear/' . $type]) !!}
                            ...
                            <tbody>
                                @foreach ($notifications->where('notification_type_id', $type) as $notification)
                                    <tr class="{{ $notification->is_unread ? 'unread' : '' }}">
                                        ...
                                        <td class="text-right"><a href="#" data-id="{{ $notification->id }}"
                                                class="clear-notification"><i class="fas fa-times"
