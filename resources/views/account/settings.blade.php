...
@section('account-content')
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            {!! Form::open(['action' => '/account/profile']) !!}
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            {!! Form::open(['action' => '/account/email']) !!}
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            {!! Form::open(['action' => '/account/password']) !!}
            <div class="form-group row">
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            @if (!isset(Auth::user()->two_factor_secret))
                ...
                {!! Form::open(['action' => '/account/two-factor/enable']) !!}
                <div class="text-right">
            ...
            @elseif(isset(Auth::user()->two_factor_secret))
                ...
                {!! Form::open(['action' => '/account/two-factor/disable']) !!}
                <div class="form-group row">
