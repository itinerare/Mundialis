...
@section('account-content')
    ...
    <p>This is a list of your watched pages. Your watched pages are only visible to you, and you will be notified on any
        change made to them (with the exception of your own changes). You can watch pages by clicking the "Watch Page" link
        in the sidebar of a page.</p>
        ...
        @foreach ($pages as $page)
            <div class="d-flex row flex-wrap col-12 mt-1 pt-2 px-0 ubt-top">
                ...
                <div class="col-md-3"><a
                        href="{{ url($page->category->subject['key']) }}">{{ $page->category->subject['name'] }}</a>/{!! $page->category->displayName !!}
                </div>
