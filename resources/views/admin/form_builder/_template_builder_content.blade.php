<p>Create or edit template information here. <strong>Note that removing fields and/or sections from this template and/or changing their keys will hide them/inputted information from any pages using them, and will cause any inputted information to be deleted on the next edit to the page.</strong> Re-adding the field/section with the same key and information will cause it to reappear.</p>
...
<p>To add fields, first add at least one section. Sections are overall headers for portions of a page. Note that <strong>changing a section's key will cause all fields for it to be deleted</strong>. Sections can also be reordered; however, note that moving sections does not cascade due to how change detection is handled.</p>
