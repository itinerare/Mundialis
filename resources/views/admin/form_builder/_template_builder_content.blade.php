<p>Create or edit template information here. <strong>Note that removing fields and/or sections from this template and/or
    ...
    and information will cause it to reappear. Please also note that certain keys are used by the site for general page
    information and may not be used as field keys. These are:</p>
<ul>
    <li>title</li>
    <li>summary</li>
    <li>description</li>
