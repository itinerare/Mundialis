        ...
        <div class="row">
            <div class="col-md">
                <div class="form-group">
                    ...
                    {!! Form::select('widget_key[]', $widgets, $widget, ['class' => 'form-control', 'placeholder' => 'Select a Widget']) !!}
                </div>
            </div>
            {!! Form::hidden('widget_section[]', $section, ['class' => 'form-control widget-section']) !!}
        </div>
    </div>
</div>
