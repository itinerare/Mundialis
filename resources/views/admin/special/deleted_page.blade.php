...
@section('admin-content')
    {!! breadcrumbs([
        'Admin' => 'admin',
        'Special/ Deleted Pages' => 'admin/special/deleted-pages',
        $page->title => 'admin/special/deleted-pages/' . $page->id,
    ]) !!}
    ...
    <a href="#" class="btn btn-info float-right restore-page-button">Restore
    ...
    <script>
        $(document).ready(function() {
            $('.restore-page-button').on('click', function(e) {
                e.preventDefault();
                loadModal("{{ url('admin/special/deleted-pages') }}/{{ $page->id }}/restore",
                    'Restore Page');
            });
        });
    </script>
