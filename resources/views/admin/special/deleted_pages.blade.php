...
@section('admin-title') Deleted Pages @endsection
...
<p>This is a list of all deleted pages on the site. So long as the categorie(s) they are in are not deleted, they will remain here in perpetuity, and may be restored at any time.</p>
...
<div class="row ml-md-2 mb-4">
    ...
    <div class="d-flex row flex-wrap col-12 mt-1 pt-2 px-0 ubt-top">
        ...
        <div class="col-md-3">
            <a href="{{ url('admin/special/deleted-pages/'.$page->id) }}" data-toggle="tooltip" title="Click to view page at this version and restore if desired">{!! format_date($page->version->created_at) !!}</a>
        </div>
        <div class="col-md-2">{!! $page->version->user->displayName !!}</div>
        <div class="col-md">
            {!! $page->version->lengthString !!} - {!! $page->version->reason ? 'Reason: <i>'.nl2br(htmlentities($page->version->reason)).'</i><br/>' : '' !!}<a class="collapse-toggle collapsed" href="#version-{{ $page->version->id }}" data-toggle="collapse">Show Raw Data <i class="fas fa-caret-right"></i></a></h3>
