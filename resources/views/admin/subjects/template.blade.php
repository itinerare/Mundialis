...
@if($template->id)
    <div class="form-group">
        ...
        {!! Form::label('cascade_template', 'Cascade Template Changes (Optional)', ['class' => 'form-check-label ml-3']) !!} {!! add_help('If this is turned on, any changes made to this template will cascade to categories in this subject that have customized templates. <strong>This includes removing elements!</strong> Changes can also be cascaded per-category, including recursively (optionally), for more precise cascading.') !!}
    </div>
@endif
