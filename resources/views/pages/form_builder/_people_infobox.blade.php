    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="row mb-2">
                <div class="col-md">
                    {!! Form::label('Place') !!}
                    {!! Form::select($segment.'_place_id', $placeOptions, isset($page->data[$segment]['place']) ? $page->data[$segment]['place'] : null, ['class' => 'form-control', 'placeholder' => 'Select a Place']) !!}
                </div>
            </div>
        </div>
        <div class="col-md">
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-4">
                    ...
                    {!! Form::select($segment.'_chronology_id', $chronologyOptions, isset($page->data[$segment]['chronology']) ? $page->data[$segment]['chronology'] : null, ['class' => 'form-control', 'placeholder' => 'Select a Chronology']) !!}
                </div>
            </div>
        </div>
    </div>
