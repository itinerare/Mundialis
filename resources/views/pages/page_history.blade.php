    ...
    <div class="row ml-md-2 mb-4">
        ...
        @foreach ($versions as $version)
            <div class="d-flex row flex-wrap col-12 mt-1 pt-2 px-0 ubt-top">
                <div class="col-md-3">
                    <a href="{{ url('pages/' . $page->id . '/history/' . $version->id) }}" data-toggle="tooltip"
                        title="Click to view page at this version{{ Auth::check() && Auth::user()->canEdit($page) ? ' and reset to this version if desired.' : '' }}">
