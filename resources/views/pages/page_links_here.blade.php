...
@section('pages-content')
    {!! breadcrumbs([
        ...
        $page->title => $page->url,
        'What Links Here' => 'pages/' . $page->id . '/links-here',
    ]) !!}

    @include('pages._page_header', ['section' => 'What Links Here'])

    <p>This is a list of all pages that link to this page. Note that this list only counts links made within page content.
    </p>
    ...
    <div class="text-center mt-4 small text-muted">{{ $links->total() }} result{{ $links->total() == 1 ? '' : 's' }}
        found.</div>
@endsection
