...
@section('pages-content')
    {!! breadcrumbs([
        ...
        $page->title => $page->url,
        'Move Page' => 'pages/' . $page->id . '/move',
    ]) !!}

    @include('pages._page_header', ['section' => 'Move Page'])

    <p>Select a category to move this page to. Note that if the selected category does not have the same template
        information, or fields, that information will be "removed" from the page. However, it will still be preserved in the
