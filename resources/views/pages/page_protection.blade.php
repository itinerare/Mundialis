...
@section('pages-title') {{ $page->title }} - Page Protection @endsection
...
<div class="card mb-4">
    <div class="card-body">
        ...
        <div class="form-group">
            {!! Form::checkbox('is_protected', 1, $page->protection ? $page->protection->is_protected : 0, ['class' => 'form-check-input', 'data-toggle' => 'toggle']) !!}
            {!! Form::label('is_protected', 'Protect Page', ['class' => 'form-check-label ml-3']) !!} {!! add_help('Whether or not the page is protected.') !!}
        </div>

        <div class="text-right">
            {!! Form::submit($page->protection && $page->protection->is_protected ? 'Edit Page Protection' : 'Protect Page', ['class' => 'btn btn-primary']) !!}
        </div>
...
<div class="card">
    <div class="card-header">
        <a class="collapse-toggle collapsed" href="#history" data-toggle="collapse">Show History <i class="fas fa-caret-right"></i></a>
    </div>
    <div class="collapse show card-body" id="history">
        ...
        <div class="row ml-md-2 mb-4">
            ...
            <div class="d-flex row flex-wrap col-12 mt-1 pt-2 px-0 ubt-top">
                ...
                <div class="col-md-2 align-self-center">{!! $protection->is_protected ? '<i class="fas fa-lock text-success" data-toggle="tooltip" title="Protected"></i>' : '<i class="fas fa-lock-open text-danger" data-toggle="tooltip" title="Unprotected"></i>' !!}</div>
        ...
        <div class="text-center mt-4 small text-muted">{{ $protections->total() }} result{{ $protections->total() == 1 ? '' : 's' }} found.</div>
    </div>
</div>
