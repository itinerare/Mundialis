...
<p>This {{ strtolower($page->category->subject['term']) }}'s ancestroy and immediate relations are listed here based on their existing relationships.</p>

<h2>Ancestry</h2>
<div class="mx-auto">
    <div class="row">
        @include('pages.relationships.tree._tree_member', ['member' => [
            'link' => null, 'type' => null, 'displayType' => '[Current Page]', 'page' => $page
        ]])
    </div>
</div>
