...
@section('pages-title') Special - User List @endsection

@section('pages-content')
{!! breadcrumbs(['Special' => 'special', 'User List' => 'special/user-list']) !!}
...
<div>
    {!! Form::open(['method' => 'GET', 'class' => 'form-inline justify-content-end']) !!}
        <div class="form-group mr-3 mb-3">
            {!! Form::text('name', Request::get('name'), ['class' => 'form-control', 'placeholder' => 'Username']) !!}
        </div>
        <div class="form-group mr-3 mb-3">
...
{!! $users->render() !!}
  <div class="row ml-md-2">
    <div class="d-flex row flex-wrap col-12 pb-1 px-0 ubt-bottom">
      ...
      <div class="col-4 col-md font-weight-bold">Joined</div>
    </div>
    @foreach($users as $user)
    <div class="d-flex row flex-wrap col-12 mt-1 pt-1 px-0 ubt-top">
      <div class="col-12 col-md-4 ">{!! $user->displayName !!}</div>
      <div class="col-4 col-md-2">{!! $user->rank->name !!}</div>
      <div class="col-4 col-md">{!! pretty_date($user->created_at, false) !!}</div>
    </div>
    @endforeach
  </div>
{!! $users->render() !!}
