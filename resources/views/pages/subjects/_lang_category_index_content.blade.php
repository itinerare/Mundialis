<div class="text-right mb-3">
    <div class="btn-group">
        <button type="button" class="btn btn-secondary active lang-category-grid-view-button" data-toggle="tooltip" title="Grid View" alt="Grid View"><i class="fas fa-th"></i></button>
        <button type="button" class="btn btn-secondary lang-category-list-view-button" data-toggle="tooltip" title="List View" alt="List View"><i class="fas fa-bars"></i></button>
    </div>
</div>
                ...
                <div class="card h-100">
                    <div class="card-header text-center">
                        @if($category->has_image)
                            <a href="{{ $category->url }}"><img src="{{ $category->imageUrl }}" class="mw-100 mb-1" /></a>
                        @endif
                        <h3>
...
<div id="langCategoryListView" class="hide">
    <div class="row">
        @foreach($categories->chunk(10) as $chunk)
            <div class="col-md">
                @foreach($chunk->groupBy(function ($item, $key) {return substr(strtolower($item->name), 0, 1);}) as $group)
