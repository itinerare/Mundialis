            ...
            <div class="card-header p-md-2 p-0">
                <div class="row no-gutters">
                    ...
                    <div class="col mx-2 mx-md-0 pt-3 pt-md-2">
                        <h5>
                            {!! $page->displayName !!}
                            {!! isset($page->data['date']['start']) ? ' ・ '.$dateHelper->formatTimeDate($page->data['date']['start']).(isset($page->data['date']['start']) && isset($page->data['date']['end']) ? '-' : '' ).(isset($page->data['date']['end']) ? $dateHelper->formatTimeDate($page->data['date']['end']) : '') : '' !!}
                            <small>
