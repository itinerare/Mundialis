...
@section('pages-content')
    ...
    <p>The following is a timeline of events recorded on this site with a set start date and/or chronology. Events are
        organized by chronology if set, and then by start date if set. The timeline can be filtered by tag(s) if desired.
    </p>
    ...
    @foreach ($chronologies as $chronology)
        <div class="row">
            ...
            @if ($eventHelper->timeOrderedEvents(Auth::check() ? Auth::user() : null,
                $chronology->id,
