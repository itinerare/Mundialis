...
<div class="row mb-4">
    ...
    <div class="col-md card my-2">
        <img src="/images/avatars/{{ $user->avatar }}" class="userAvatar mobile-hide" style="position:absolute;width:200px;height:200px;margin-top:-10px; margin-left:-10px;
        margin-right:25px;">
        <div>
            <img src="/images/avatars/{{ $user->avatar }}" class="userAvatar float-left mobile-hide" style="width:175px;height:175px;
            margin-right:25px;">
