    ...
    *******************************************************************************/
    ...
    public static function getSubjectIndexProvider() {
        return [
            ...
            'factions with category'  => ['factions', 1, 0],
            'factions with unrelated' => ['factions', 0, 1],
    ...
    *******************************************************************************/
    ...
    public static function getEditSubjectTemplateProvider() {
        return [
            ...
            'factions'           => ['factions', 0, 200],
            'factions with data' => ['factions', 1, 200],
    ...
    public static function postEditSubjectTemplateProvider() {
        return [
            ...
            'factions'           => ['factions', 0, 0, 1],
            'factions with data' => ['factions', 1, 0, 1],
            'factions cascaded'  => ['factions', 1, 1, 1],
